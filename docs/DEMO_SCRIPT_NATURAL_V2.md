# Demo Video Script — Natural Voice V2
...
**Screen:** Select **Photo or screenshot**. Add `high-risk-bank-text-v2-page-1.png` and
`high-risk-bank-text-v2-page-2.png`. Briefly show the two ordered previews, then press **Check these
